...
// var usersArr = Object.entries(users)
...
class Mammal extends Animal {
    ...
    sound(soundOfAnimal) {
        ...
        console.log(`The ${this.type} whos name is ${this.name} is ${this.color} and makes ${this.sound} sound`)

    }
}

const myAnimal = new Mammal('Buddy', 'dog', 'golden');
myAnimal.sound('woof')
