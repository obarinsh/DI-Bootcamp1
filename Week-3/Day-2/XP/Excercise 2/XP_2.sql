...
-- SELECT * FROM film
-- SELECT film_id,title,description,length,rental_rate FROM film WHERE title='Amelie'
...
-- SELECT film_id,title,description,length,rental_rate FROM film WHERE title LIKE 'Am%'
